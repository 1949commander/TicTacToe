...
// this function styles the game butttons while they are disabled
...
// this function will clear the text from message console
function clearMsg() {
...
function checkWinCon5(info,squareArray) {
    ...
    for ( var i in info) {
     ...
     // this will trigger (ONLY) if there was a match for index1, index4 and index7
...
function checkWinCon7(info,squareArray) {
    ...
    for ( var i in info) {
     ...
     // this will trigger (ONLY) if there was a match for index6, index4 and index2
...
function checkWinCon8(info,squareArray) {
    ...
    // this will trigger (ONLY) if there was a match for index0, index4 and index8
...
function square2Animate() {
    ...
    if (activePlayer != "Game Stopped") { // if the game has not yet started prevent avatar placement
        var square = "1"; // identified the square selected
        // check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
...
function square3Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { // if the game has not yet started prevent avatar placement
        var square = "2"; // identified the square selected
        // check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
            // get the correct avatar to paint for the active player
...
function square4Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { // if the game has not yet started prevent avatar placement
        var square = "3"; // identified the square selected
        // check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
            // get the correct avatar to paint for the active player
...
function square5Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { // if the game has not yet started prevent avatar placement
        var square = "4"; // identified the square selected
        // check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
            // get the correct avatar to paint for the active player
...
function square6Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { // if the game has not yet started prevent avatar placement
        var square = "5"; // identified the square selected
        // check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
            // get the correct avatar to paint for the active player
...
function square7Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { // if the game has not yet started prevent avatar placement
        var square = "6"; // identified the square selected
        // check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
            // get the correct avatar to paint for the active player
...
function square8Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { // if the game has not yet started prevent avatar placement
        var square = "7"; // identified the square selected
        // check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
            // get the correct avatar to paint for the active player
...
function square9Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { // if the game has not yet started prevent avatar placement
        var square = "8"; // identified the square selected
        // check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
            // get the correct avatar to paint for the active player
